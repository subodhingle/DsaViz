...
const COMPLEXITY = {
  ...
  dijkstra:      { time: 'O((V+E) log V)',  best: 'O(E log V)', space: 'O(V)' },
...
export default function StatsPanel() {
  ...
  const stats = [
    { icon: Eye,           label: 'Comparisons', value: comparisons },
    { icon: ArrowLeftRight,label: 'Swaps',        value: swaps },
    { icon: Activity,      label: 'Steps',        value: steps.length },
    { icon: TrendingUp,    label: 'Progress',     value: `${progress}%` },
  ]

  return (
    <div
      className="shrink-0 flex items-center gap-0 overflow-x-auto"
      style={{
